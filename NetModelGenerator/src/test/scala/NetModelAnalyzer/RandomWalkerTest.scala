...
class RandomWalkerTest extends AnyFlatSpec with Matchers with MockitoSugar with PrivateMethodTester {
  ...
  val edge12: Action = Action(actionType = 1, fromNode = 1, toNode = 2, fromId = 1, toId = 2, resultingValue = Some(1), cost = 0.1)
  val edge13: Action = Action(actionType = 2, fromNode = 1, toNode = 3, fromId = 1, toId = 3, resultingValue = Some(2), cost = 0.2)
  val edge14: Action = Action(actionType = 3, fromNode = 1, toNode = 4,  fromId = 1, toId = 4, resultingValue = Some(3), cost = 0.3)
  val edge25: Action = Action(actionType = 4, fromNode = 2, toNode = 5, fromId = 2, toId = 5, resultingValue = Some(4), cost = 0.4)
  val edge26: Action = Action(actionType = 5, fromNode = 2, toNode = 6, fromId = 2, toId = 6, resultingValue = Some(5), cost = 0.5)
  val edge35: Action = Action(actionType = 6, fromNode = 3, toNode = 5, fromId = 3, toId = 5, resultingValue = Some(6), cost = 0.6)
  val edge37: Action = Action(actionType = 7, fromNode = 3, toNode = 7, fromId = 3, toId = 7, resultingValue = Some(7), cost = 0.7)
  val edge47: Action = Action(actionType = 8, fromNode = 4, toNode = 7, fromId = 4, toId = 7, resultingValue = Some(8), cost = 0.8)
  val edge58: Action = Action(actionType = 9, fromNode = 5, toNode = 8, fromId = 5, toId = 8, resultingValue = Some(9), cost = 0.9)
  val edge68: Action = Action(actionType = 10, fromNode = 6, toNode = 8, fromId = 6, toId = 8, resultingValue = Some(10), cost = 0.91)
  val edge78: Action = Action(actionType = 11, fromNode = 7, toNode = 8, fromId = 7, toId = 8, resultingValue = Some(11), cost = 0.92)
  val edge79: Action = Action(actionType = 12, fromNode = 7, toNode = 9, fromId = 7, toId = 9, resultingValue = Some(12), cost = 0.93)
  val edge82: Action = Action(actionType = 13, fromNode = 8, toNode = 2, fromId = 8, toId = 2, resultingValue = Some(13), cost = 0.94)
  val edge84: Action = Action(actionType = 14, fromNode = 8, toNode = 4, fromId = 8, toId = 4, resultingValue = Some(14), cost = 0.95)
  val edge89: Action = Action(actionType = 15, fromNode = 8, toNode = 9, fromId = 8, toId = 9, resultingValue = Some(15), cost = 0.96)
